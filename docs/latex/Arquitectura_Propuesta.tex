...
En este primer caso no se inyectó ninguna falla en las mediciones de la IMU. Se ejecutó el set de tareas antes mencionado durante 60 segundos, orientando a las réplicas siguiendo el esquema de la figura  . Para que la orientación de las réplicas fuera la misma en todo momento, estas se apilaron con una serie de soportes, como se muestra en la figura . Además, el conjunto de placas se montó sobre una base plana facilitando el movimiento y la orientación manual.
