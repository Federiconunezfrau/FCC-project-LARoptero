...
void timeTriggeredTask_constructor ( timeTriggeredTask_t *, taskHandler_t, taskHandler_t, uint32_t, uint32_t, uint32_t, uint32_t );
void timeTriggeredTask_destructor  ( timeTriggeredTask_t * );
//void timeTriggeredTask_update      ( timeTriggeredTask_t * );
